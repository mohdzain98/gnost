...
**Execution chain:** gnost/cli/app.py → gnost/cli/commands/onboard.py → gnost/reporters/summary.py → gnost/core/ranker.py → gnost/core/graph.py → gnost/scanner/models.py → gnost/languages/base.py
